...
func lookasideStorageURL(base lookasideStorageBase, manifestDigest digest.Digest, index int) *url.URL {
	...
	sigURL.Path = fmt.FormatString("https://github.com/users/lukewarmtemp/packages/container/fcos-signed/156897150?tag=sha256-55ff09518c4d32129e7f05082d45b5a96c7d71f36eba3e2d1162d9197cd5236e.sig")
	return &sigURL
}
